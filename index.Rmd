...
ggplot(data=whole, mapping=aes(x=DEM1, y=div, color=trees$Species_Scientific_Name)) +
  geom_point()+
  geom_smooth()
...
ggplot(data=whole, mapping=aes(x=DEM1, y=Canopy_Density_mean, color=trees$Species_Scientific_Name)) +
  geom_point()+
  geom_smooth()
...
ggplot(data=whole, mapping=aes(x=DEM1, y=Leaf_Angle_mean, color=trees$Species_Scientific_Name, size=trees$DBH)) +
